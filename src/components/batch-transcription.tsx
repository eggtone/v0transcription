...
import { DetailedTranscription, TranscriptionSegment, QueuedAudioItem } from "@/types";
import { AudioPart, MP3Quality, splitAudioFile, formatFileSize, getAudioDuration } from "@/utils/audio-utils";
import { processSplitAudioParts, SplitAudioState } from "@/utils/audio-split-utils";
import JSZip from "jszip";
import { useBatchQueueStore, EnhancedQueuedAudioItem } from "@/store/batchQueueStore";
import path from "path";
import { triggerBrowserDownload, generateMetadataCsv } from "@/utils/download-utils";
